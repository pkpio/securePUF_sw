...
//For couting #1's in runSize runs for each bits. Initialized to 0 for each bit.
...
//############################### This is specific to stage 4	#####################################
	string stage4ResponsesFile = "stage4_responses.txt";
	ofstream s4RespFile (stage4ResponsesFile);
...
//################################################################################################################################	
	...
	for (int challLoop = 0; challLoop < challengeLoopSize; challLoop++) {
		...
		//###########################################     Writing results to files    ###############################################################
			//Skip writing to files for each individual response
			/*
			std::string runNum;
			std::stringstream out;
			...
			string outFileName = "stage4_run #"+runNum+".txt";
			...
			*/
			...
			//##################################	For stage 4 results	report ##################################
			//Writing 16-bit response for each execution into the stage 4 results file
			s4RespFile<<get8bitBinary(outputValues[0])<<get8bitBinary(outputValues[1])<<endl;

			////################################## end of stage 4 results report ##################################
...
//##################################################### One last write of consoldated result #####################################
	...
	//File heading
	outfile << "Stage 4 final report" << endl<<endl;
